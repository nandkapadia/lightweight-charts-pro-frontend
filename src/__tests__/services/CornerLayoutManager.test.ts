...
describe("CornerLayoutManager", () => {
  ...
  describe("Widget Positioning", () => {
    it("should position widget in top-left corner", () => {
      const manager = CornerLayoutManager.getInstance("chart-1", 0);
      const widget = createMockWidget("widget-1", "top-left", 0, {
        width: 100,
        height: 20,
      });
    ...
    it("should position widget in top-right corner", () => {
      const manager = CornerLayoutManager.getInstance("chart-1", 0);
      const widget = createMockWidget("widget-1", "top-right", 0, {
        width: 100,
        height: 20,
      });
    ...
    it("should position widget in bottom-left corner", () => {
      const manager = CornerLayoutManager.getInstance("chart-1", 0);
      const widget = createMockWidget("widget-1", "bottom-left", 0, {
        width: 100,
        height: 20,
      });
    ...
    it("should position widget in bottom-right corner", () => {
      const manager = CornerLayoutManager.getInstance("chart-1", 0);
      const widget = createMockWidget("widget-1", "bottom-right", 0, {
        width: 100,
        height: 20,
      });
    ...
    it("should stack widgets vertically with gaps", () => {
      const manager = CornerLayoutManager.getInstance("chart-1", 0);
      const widget1 = createMockWidget("widget-1", "top-left", 1, {
        width: 100,
        height: 20,
      });
      const widget2 = createMockWidget("widget-2", "top-left", 2, {
        width: 100,
        height: 20,
      });
