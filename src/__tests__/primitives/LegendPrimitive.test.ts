...
describe("LegendPrimitive - Construction", () => {
  ...
  it("should apply default styling", () => {
    ...
    expect((legend as any).config.style.backgroundColor).toBe(
      "rgba(0, 0, 0, 0.8)",
    );
...
describe("LegendPrimitive - Color Opacity Adjustment", () => {
  ...
  it("should adjust rgba color opacity", () => {
    const result = (legend as any).adjustColorOpacity(
      "rgba(255, 0, 0, 0.5)",
      0.8,
    );
...
describe("Default Configurations", () => {
  ...
  it("should provide OHLC config", () => {
    expect(DefaultLegendConfigs.ohlc.text).toBe(
  ...
  it("should provide band config", () => {
    expect(DefaultLegendConfigs.band.text).toBe(
  ...
  it("should have consistent styling in configs", () => {
    expect(DefaultLegendConfigs.simple.style.backgroundColor).toBe(
      "rgba(0, 0, 0, 0.8)",
    );
    expect(DefaultLegendConfigs.ohlc.style.backgroundColor).toBe(
      "rgba(0, 0, 0, 0.8)",
    );
    expect(DefaultLegendConfigs.volume.style.backgroundColor).toBe(
      "rgba(0, 0, 0, 0.6)",
    );
    expect(DefaultLegendConfigs.band.style.backgroundColor).toBe(
      "rgba(0, 0, 0, 0.7)",
    );
  });
});
...
describe("LegendPrimitive - Edge Cases", () => {
  ...
  it("should handle complex nested styling", () => {
    ...
    expect((legend as any).config.style.textShadow).toBe(
