...
describe("TooltipPlugin - Refactored Minimal Renderer", () => {
  ...
  describe("show()", () => {
    ...
    it("should handle multiple show() calls", () => {
      tooltipPlugin.show("<div>First</div>", "background: red;", {
        x: 10,
        y: 10,
      });
      tooltipPlugin.show("<div>Second</div>", "background: blue;", {
        x: 20,
        y: 20,
      });
  ...
  describe("hide()", () => {
    ...
    it("should hide visible tooltip", () => {
      // Show tooltip first
      tooltipPlugin.show("<div>Visible</div>", "background: green;", {
        x: 100,
        y: 100,
      });
  ...
  describe("updatePosition()", () => {
    ...
    it("should update tooltip position when visible", () => {
      // Show tooltip
      tooltipPlugin.show("<div>Moving Tooltip</div>", "background: yellow;", {
        x: 100,
        y: 100,
      });
    ...
    it("should not update position when hidden", () => {
      // Show then hide
      tooltipPlugin.show("<div>Hidden</div>", "background: gray;", {
        x: 50,
        y: 50,
      });
      tooltipPlugin.hide();
  ...
  describe("destroy()", () => {
    ...
    it("should remove tooltip element from DOM", () => {
      // Show tooltip
      tooltipPlugin.show("<div>Destroy Me</div>", "background: red;", {
        x: 50,
        y: 50,
      });
  ...
  describe("remove()", () => {
    ...
    it("should be an alias for destroy()", () => {
      tooltipPlugin.show("<div>Remove Me</div>", "background: purple;", {
        x: 75,
        y: 75,
      });
  ...
  describe("Error Handling", () => {
    it("should handle invalid container gracefully", () => {
      ...
      expect(() => {
        tooltipPlugin.show("<div>Error</div>", "background: red;", {
          x: 0,
          y: 0,
        });
      }).not.toThrow();
    ...
    it("should handle null style object values", () => {
      ...
      expect(() => {
        tooltipPlugin.show("<div>Null Styles</div>", styleWithNulls, {
          x: 100,
          y: 100,
        });
      }).not.toThrow();
