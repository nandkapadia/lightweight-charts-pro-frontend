...
class SignalPrimitivePaneView extends TrendFillPrimitive.BaseSeriesPrimitivePaneView {
  renderer() {
  ...
  drawBackground(target) {
    target.useBitmapCoordinateSpace((scope) => {
      ...
      for (const item of data) {
        const x = TrendFillPrimitive.timeToCoordinate(item.time, chart);
        if (x === null) continue;
...
class SignalPrimitive extends TrendFillPrimitive.BaseSeriesPrimitive {
...
exports.SignalPrimitive = SignalPrimitive;
//# sourceMappingURL=SignalPrimitive-DKmHoKb-.cjs.map
