...
class BasePanePrimitive {
  ...
  get coordinateService() {
    if (!this._coordinateService) {
      this._coordinateService = SingletonBase.createSingleton(SingletonBase.ChartCoordinateService);
    }
    if (!this._coordinateService) {
  ...
  get templateEngine() {
    if (!this._templateEngine) {
      this._templateEngine = SingletonBase.createSingleton(TradeTemplateProcessor.TemplateEngine);
    }
    if (!this._templateEngine) {
  ...
  initializeEventManagement() {
    if (!this.chart) return;
    const chartId = this.getChartId();
    this.eventManager = PrimitiveEventManager.PrimitiveEventManager.getInstance(chartId);
...
class LegendPrimitive extends BasePanePrimitive {
  constructor(id, config) {
    const configWithDefaults = {
      ...
      valueFormat: config.valueFormat ?? SingletonBase.FormatDefaults.VALUE_FORMAT,
      style: {
        backgroundColor: SingletonBase.LegendColors.DEFAULT_BACKGROUND,
        color: SingletonBase.LegendColors.DEFAULT_COLOR,
        fontSize: SingletonBase.LegendDimensions.FONT_SIZE,
        fontFamily: SingletonBase.ContainerDefaults.FONT_FAMILY,
        padding: SingletonBase.LegendDimensions.DEFAULT_PADDING,
        borderRadius: SingletonBase.LegendDimensions.BORDER_RADIUS,
        textAlign: SingletonBase.ContainerDefaults.TEXT_ALIGN,
        fontWeight: SingletonBase.ContainerDefaults.FONT_WEIGHT,
        backgroundOpacity: SingletonBase.LegendColors.DEFAULT_OPACITY,
        ...config.style
      }
    };
  ...
  renderContent() {
    ...
    legendElement.innerHTML = sanitization.sanitizeHtml(content);
  ...
  applyLegendStyling(element) {
    ...
    if (config) {
      ...
      const baseStyles = {
        cursor: SingletonBase.CommonValues.DEFAULT_CURSOR
      };
      ...
      const style = element.style;
      style.userSelect = SingletonBase.CommonValues.NONE;
      style.pointerEvents = SingletonBase.CommonValues.NONE;
      style.whiteSpace = SingletonBase.CommonValues.NOWRAP;
      style.overflow = SingletonBase.CommonValues.HIDDEN;
      style.textOverflow = SingletonBase.CommonValues.ELLIPSIS;
      style.maxWidth = `${SingletonBase.LegendDimensions.MAX_WIDTH}px`;
      style.lineHeight = "1";
  ...
  updateLegendFromCrosshair(event) {
    if (!event.time || !this.series || event.seriesData.size === 0) {
      this.updateTemplateContext({
        seriesData: void 0,
        formatting: {
          valueFormat: this.config.valueFormat || SingletonBase.FormatDefaults.VALUE_FORMAT
        }
      });
      return;
    }
    ...
    if (seriesValue) {
      this.updateTemplateContext({
        ...
        formatting: {
          valueFormat: this.config.valueFormat || SingletonBase.FormatDefaults.VALUE_FORMAT,
          timeFormat: SingletonBase.FormatDefaults.TIME_FORMAT
        }
      });
    }
  }
...
const DefaultLegendConfigs = {
  ...
  simple: {
    text: "$$value$$",
    valueFormat: SingletonBase.FormatDefaults.VALUE_FORMAT,
    style: {
      backgroundColor: SingletonBase.LegendColors.DEFAULT_BACKGROUND,
      color: SingletonBase.LegendColors.DEFAULT_COLOR,
      padding: SingletonBase.LegendDimensions.DEFAULT_PADDING,
  ...
  ohlc: {
    ...
    style: {
      backgroundColor: SingletonBase.LegendColors.DEFAULT_BACKGROUND,
      color: SingletonBase.LegendColors.DEFAULT_COLOR,
      padding: SingletonBase.LegendDimensions.OHLC_PADDING,
      borderRadius: SingletonBase.LegendDimensions.BORDER_RADIUS,
      fontSize: SingletonBase.LegendDimensions.OHLC_FONT_SIZE
    }
  },
  /**
   * Volume legend
  ...
  volume: {
    text: "Vol: $$volume$$",
    valueFormat: SingletonBase.FormatDefaults.VOLUME_FORMAT,
    style: {
      backgroundColor: SingletonBase.LegendColors.VOLUME_BACKGROUND,
      color: SingletonBase.LegendColors.DEFAULT_COLOR,
      padding: SingletonBase.LegendDimensions.DEFAULT_PADDING,
      borderRadius: SingletonBase.LegendDimensions.BORDER_RADIUS
    }
  ...
  band: {
    ...
    valueFormat: SingletonBase.FormatDefaults.BAND_FORMAT,
    style: {
      backgroundColor: SingletonBase.LegendColors.BAND_BACKGROUND,
      color: SingletonBase.LegendColors.DEFAULT_COLOR,
      padding: SingletonBase.LegendDimensions.BAND_PADDING,
      borderRadius: SingletonBase.LegendDimensions.BORDER_RADIUS,
      fontSize: SingletonBase.LegendDimensions.BAND_FONT_SIZE
    }
  }
};
...
function getSecondsFromRange(range) {
  ...
  switch (range) {
    case "FIVE_MINUTES":
      return SingletonBase.TimeRangeSeconds.FIVE_MINUTES;
    case "FIFTEEN_MINUTES":
      return SingletonBase.TimeRangeSeconds.FIFTEEN_MINUTES;
    case "THIRTY_MINUTES":
      return 1800;
    // 30 minutes
    case "ONE_HOUR":
      return SingletonBase.TimeRangeSeconds.ONE_HOUR;
    case "FOUR_HOURS":
      return SingletonBase.TimeRangeSeconds.FOUR_HOURS;
    case "ONE_DAY":
      return SingletonBase.TimeRangeSeconds.ONE_DAY;
    case "ONE_WEEK":
      return SingletonBase.TimeRangeSeconds.ONE_WEEK;
    case "TWO_WEEKS":
      return SingletonBase.TimeRangeSeconds.ONE_WEEK * 2;
    case "ONE_MONTH":
      return SingletonBase.TimeRangeSeconds.ONE_MONTH;
    case "THREE_MONTHS":
      return SingletonBase.TimeRangeSeconds.THREE_MONTHS;
    case "SIX_MONTHS":
      return SingletonBase.TimeRangeSeconds.SIX_MONTHS;
    case "ONE_YEAR":
      return SingletonBase.TimeRangeSeconds.ONE_YEAR;
    case "TWO_YEARS":
      return SingletonBase.TimeRangeSeconds.ONE_YEAR * 2;
    case "FIVE_YEARS":
      return SingletonBase.TimeRangeSeconds.FIVE_YEARS;
    default:
      return null;
  }
}
class RangeSwitcherPrimitive extends BasePanePrimitive {
  ...
  constructor(id, config) {
    const configWithDefaults = {
      ...
      style: {
        ...
        padding: SingletonBase.DefaultRangeSwitcherConfig.layout.CONTAINER_PADDING,
        container: {
          display: "flex",
          flexDirection: SingletonBase.DefaultRangeSwitcherConfig.layout.FLEX_DIRECTION,
          gap: SingletonBase.DefaultRangeSwitcherConfig.layout.CONTAINER_GAP,
          alignItems: SingletonBase.DefaultRangeSwitcherConfig.layout.ALIGN_ITEMS,
          justifyContent: SingletonBase.DefaultRangeSwitcherConfig.layout.JUSTIFY_CONTENT
        },
        button: {
          backgroundColor: SingletonBase.ButtonColors.DEFAULT_BACKGROUND,
          color: SingletonBase.ButtonColors.DEFAULT_COLOR,
          hoverBackgroundColor: SingletonBase.ButtonColors.HOVER_BACKGROUND,
          hoverColor: SingletonBase.ButtonColors.HOVER_COLOR,
          border: SingletonBase.ButtonEffects.DEFAULT_BORDER,
          borderRadius: SingletonBase.ButtonDimensions.BORDER_RADIUS,
          padding: SingletonBase.ButtonSpacing.RANGE_BUTTON_PADDING,
          margin: "0 2px",
          fontSize: SingletonBase.ButtonDimensions.RANGE_FONT_SIZE,
          fontWeight: 500,
          minWidth: SingletonBase.ButtonDimensions.MIN_WIDTH_RANGE
        },
        ...config.style
      }
    };
  ...
  applyButtonStyling(button, isActive, isHover = false) {
    ...
    if (buttonConfig) {
      const baseStyles = {
        border: buttonConfig.border || SingletonBase.ButtonEffects.RANGE_BORDER,
        borderRadius: buttonConfig.borderRadius || 4,
        // Rounded corners for modern look
        padding: buttonConfig.padding || SingletonBase.ButtonSpacing.RANGE_BUTTON_PADDING,
        margin: buttonConfig.margin || SingletonBase.ButtonSpacing.RANGE_BUTTON_MARGIN,
        fontSize: buttonConfig.fontSize || 11,
        // Slightly smaller font for compactness
        fontWeight: buttonConfig.fontWeight || SingletonBase.CommonValues.FONT_WEIGHT_MEDIUM,
        backgroundColor: buttonConfig.backgroundColor || "rgba(255, 255, 255, 0.9)",
        color: buttonConfig.color || "#666",
        cursor: SingletonBase.CommonValues.POINTER,
        transition: SingletonBase.ButtonEffects.DEFAULT_TRANSITION,
      ...
      if (isHover) {
        ...
        stateStyles.boxShadow = SingletonBase.ButtonEffects.RANGE_HOVER_BOX_SHADOW;
...
const DefaultRangeConfigs = {
  ...
  legacy: {
    trading: [
      { text: "1D", seconds: SingletonBase.TimeRangeSeconds.ONE_DAY },
      { text: "7D", seconds: SingletonBase.TimeRangeSeconds.ONE_WEEK },
      { text: "1M", seconds: SingletonBase.TimeRangeSeconds.ONE_MONTH },
      { text: "3M", seconds: SingletonBase.TimeRangeSeconds.THREE_MONTHS },
      { text: "1Y", seconds: SingletonBase.TimeRangeSeconds.ONE_YEAR },
      { text: "All", seconds: null }
    ],
    shortTerm: [
      { text: "5M", seconds: SingletonBase.TimeRangeSeconds.FIVE_MINUTES },
      { text: "15M", seconds: SingletonBase.TimeRangeSeconds.FIFTEEN_MINUTES },
      { text: "1H", seconds: SingletonBase.TimeRangeSeconds.ONE_HOUR },
      { text: "4H", seconds: SingletonBase.TimeRangeSeconds.FOUR_HOURS },
      { text: "1D", seconds: SingletonBase.TimeRangeSeconds.ONE_DAY },
      { text: "All", seconds: null }
    ],
    longTerm: [
      { text: "1M", seconds: SingletonBase.TimeRangeSeconds.ONE_MONTH },
      { text: "3M", seconds: SingletonBase.TimeRangeSeconds.THREE_MONTHS },
      { text: "6M", seconds: SingletonBase.TimeRangeSeconds.SIX_MONTHS },
      { text: "1Y", seconds: SingletonBase.TimeRangeSeconds.ONE_YEAR },
      { text: "5Y", seconds: SingletonBase.TimeRangeSeconds.FIVE_YEARS },
      { text: "All", seconds: null }
    ],
    minimal: [
      { text: "1D", seconds: SingletonBase.TimeRangeSeconds.ONE_DAY },
      { text: "1W", seconds: SingletonBase.TimeRangeSeconds.ONE_WEEK },
      { text: "1M", seconds: SingletonBase.TimeRangeSeconds.ONE_MONTH },
      { text: "All", seconds: null }
    ]
  }
...
class TradeRectanglePrimitive {
  ...
  handleCrosshairMove(param) {
    ...
    try {
      ...
      if (isHit) {
        TooltipManager.TooltipManager.getInstance().requestTooltip({
...
exports.AnimationTiming = SingletonBase.AnimationTiming;
...
exports.ButtonSpacing = SingletonBase.ButtonSpacing;
exports.CommonValues = SingletonBase.CommonValues;
exports.ContainerDefaults = SingletonBase.ContainerDefaults;
exports.DefaultButtonConfig = SingletonBase.DefaultButtonConfig;
exports.DefaultContainerConfig = SingletonBase.DefaultContainerConfig;
exports.DefaultLegendConfig = SingletonBase.DefaultLegendConfig;
exports.DefaultRangeSwitcherConfig = SingletonBase.DefaultRangeSwitcherConfig;
exports.FormatDefaults = SingletonBase.FormatDefaults;
exports.LayoutSpacing = SingletonBase.LayoutSpacing;
exports.LegendColors = SingletonBase.LegendColors;
exports.LegendDimensions = SingletonBase.LegendDimensions;
exports.RangeSwitcherLayout = SingletonBase.RangeSwitcherLayout;
exports.TimeRangeSeconds = SingletonBase.TimeRangeSeconds;
...
exports.BasePanePrimitive = BasePanePrimitive;
exports.DefaultLegendConfigs = DefaultLegendConfigs;
exports.DefaultRangeConfigs = DefaultRangeConfigs;
exports.LegendPrimitive = LegendPrimitive;
exports.PrimitivePriority = PrimitivePriority;
exports.PrimitiveStylingUtils = PrimitiveStylingUtils;
exports.RangeSwitcherPrimitive = RangeSwitcherPrimitive;
exports.TimeRange = TimeRange;
exports.TradeRectanglePrimitive = TradeRectanglePrimitive;
exports.createLegendPrimitive = createLegendPrimitive;
exports.createRangeSwitcherPrimitive = createRangeSwitcherPrimitive;
