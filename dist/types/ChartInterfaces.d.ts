import { IChartApi, ISeriesApi, UTCTimestamp, SeriesOptionsMap, Time, CustomData, BarData, LineData, HistogramData, CandlestickData, AreaData, BaselineData } from 'lightweight-charts';
/**
 ...
 */
export interface ExtendedSeriesApi<TData extends keyof SeriesOptionsMap = keyof SeriesOptionsMap> extends ISeriesApi<TData> {
    paneId?: number;
 ...
 */
export type SeriesDataPoint = OHLCDataPoint | LineDataPoint | HistogramDataPoint | BaselineDataPoint | BandDataPoint | CustomData<Time> | BarData<Time> | LineData<Time> | HistogramData<Time> | CandlestickData<Time> | AreaData<Time> | BaselineData<Time>;
/**
...
//# sourceMappingURL=ChartInterfaces.d.ts.map