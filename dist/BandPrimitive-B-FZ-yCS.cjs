...
class BandPrimitivePaneView extends TrendFillPrimitive.BaseSeriesPrimitivePaneView {
  renderer() {
...
class BandPrimitiveRenderer {
  ...
  draw(target) {
    target.useBitmapCoordinateSpace((scope) => {
      ...
      const coordinates = TrendFillPrimitive.convertToCoordinates(data, chart, series, ["upper", "middle", "lower"]);
...
const BandUpperAxisView = TrendFillPrimitive.createPrimitiveAxisView(
  "upper",
  "upperLineColor"
);
const BandMiddleAxisView = TrendFillPrimitive.createPrimitiveAxisView(
  "middle",
  "middleLineColor"
);
const BandLowerAxisView = TrendFillPrimitive.createPrimitiveAxisView(
  "lower",
  "lowerLineColor"
);
class BandPrimitive extends TrendFillPrimitive.BaseSeriesPrimitive {
...
exports.BandPrimitive = BandPrimitive;
//# sourceMappingURL=BandPrimitive-B-FZ-yCS.cjs.map
