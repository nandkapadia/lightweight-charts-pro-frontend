import { LineStyle, LineSeries, AreaSeries, HistogramSeries, BarSeries, CandlestickSeries, BaselineSeries, createSeriesMarkers } from "lightweight-charts";
import { c as createBandSeries, a as createRibbonSeries, b as createGradientRibbonSeries, e as createSignalSeries, h as createTrendFillSeries } from "./trendFillSeriesPlugin-KufklRJL.js";
import { c as cleanLineStyleOptions } from "./lineStyle-Ds69R7UM.js";
import { l as logger } from "./SingletonBase-MBQ3miuj.js";
import { c as createTradeVisualElements } from "./tradeVisualization-8Mmrhv2M.js";
...
const BAND_SERIES_DESCRIPTOR = {
  ...
  create: (chart, data, options, paneId = 0) => {
    return createBandSeries(chart, { ...options, data, paneId });
  }
};
const RIBBON_SERIES_DESCRIPTOR = {
  ...
  // Factory accepts additional options beyond primitive options
  create: (chart, data, options, paneId = 0) => {
    return createRibbonSeries(chart, { ...options, data, paneId });
  }
};
const GRADIENT_RIBBON_SERIES_DESCRIPTOR = {
  ...
  // Factory accepts additional options beyond primitive options
  create: (chart, data, options, paneId = 0) => {
    return createGradientRibbonSeries(chart, {
      ...options,
      data,
      paneId
    });
...
const SIGNAL_SERIES_DESCRIPTOR = {
  ...
  // Factory accepts additional options beyond primitive options
  create: (chart, data, options, paneId = 0) => {
    return createSignalSeries(chart, { ...options, data, paneId });
  }
};
...
export {
  AREA_SERIES_DESCRIPTOR as A,
  BAR_SERIES_DESCRIPTOR as B,
  CANDLESTICK_SERIES_DESCRIPTOR as C,
  GRADIENT_RIBBON_SERIES_DESCRIPTOR as G,
  HISTOGRAM_SERIES_DESCRIPTOR as H,
  LINE_SERIES_DESCRIPTOR as L,
  PropertyMapper as P,
  RIBBON_SERIES_DESCRIPTOR as R,
  SeriesFactory as S,
  TREND_FILL_SERIES_DESCRIPTOR as T,
  SeriesCreationError as a,
  getAvailableSeriesTypes as b,
  createSeries as c,
  getDefaultOptions as d,
  getSeriesDescriptorsByCategory as e,
  createSeriesWithConfig as f,
  getSeriesDescriptor as g,
  updateSeriesData as h,
  isCustomSeries as i,
  updateSeriesMarkers as j,
  updateSeriesOptions as k,
  PropertyDescriptors as l,
  STANDARD_SERIES_PROPERTIES as m,
  extractDefaultOptions as n,
  dialogConfigToApiOptions$1 as o,
  apiOptionsToDialogConfig$1 as p,
  BASELINE_SERIES_DESCRIPTOR as q,
  registerSeriesDescriptor as r,
  BUILTIN_SERIES_DESCRIPTORS as s,
  BAND_SERIES_DESCRIPTOR as t,
  unregisterSeriesDescriptor as u,
  SIGNAL_SERIES_DESCRIPTOR as v,
  CUSTOM_SERIES_DESCRIPTORS as w,
  normalizeSeriesType as x
};
//# sourceMappingURL=UnifiedPropertyMapper-DPcZdF4d.js.map
